...
public class Main {
  ...
  public static void main(String[] args) {
    //If there are any arguments, that means we are going to be running our test suite
    if (args.length > 0) {
      Test.handleArguments(args);
      return;
    }

    //If we get here, we are not doing a test run, but instead are doing things manually.----------------------------------------
